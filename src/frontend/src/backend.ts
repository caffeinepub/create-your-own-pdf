...
import type { ExternalBlob as _ExternalBlob, PublishedPdf as _PublishedPdf, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getPdfList(): Promise<Array<PublishedPdf>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPdfList();
    ...
    async getPublished(arg0: string): Promise<PublishedPdf> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublished(arg0);
                return from_candid_PublishedPdf_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async publish(arg0: ExternalBlob, arg1: string, arg2: string, arg3: string, arg4: boolean, arg5: boolean, arg6: string | null, arg7: string | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.publish(await to_candid_ExternalBlob_n13(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, arg4, arg5, to_candid_opt_n14(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchPublished(arg0: string): Promise<Array<PublishedPdf>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchPublished(arg0);
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PublishedPdf_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublishedPdf): Promise<PublishedPdf> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        originalFileName: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.originalFileName)),
        title: value.title,
        blob: await from_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.blob),
        authorName: value.authorName,
        isSearchable: value.isSearchable,
        originalAuthor: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.originalAuthor)),
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublishedPdf>): Promise<Array<PublishedPdf>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublishedPdf_n9(_uploadFile, _downloadFile, x)));
}
